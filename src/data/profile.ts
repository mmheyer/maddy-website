export const profile = {
  name: 'Maddy Heyer',
  tagline:
    "Master's student in CSE at the University of Michigan",
  email: 'mmheyer@umich.edu',
  ...
  education: [
    ...
    {
      degree: 'B.S.E in Computer Science and Engineering',
      school: 'University of Michigan',
      minor: 'Minor in Statistics',
      gpa: '3.8/4.0',
      dates: 'Aug 2021 – May 2025',
      coursework:
        'Machine Learning, Computer Architecture, Web Systems, Databases, Computer Networks, Software Engineering, Computer Vision',
    },
  ],
  honors: [
    'Summa Cum Laude',
